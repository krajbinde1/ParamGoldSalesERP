...
<style>
    ...
    /* KPI row — wrap by available width; never force 6-up */
    .pg-admin-dash .pg-kpi-grid,
    .pg-admin-dash .pg-kpi-grid--6 {
        display: grid;
    ...
    .pg-admin-dash .pg-status-grid--3,
    .pg-admin-dash .pg-status-grid--4 {
        display: grid;
