...
<style>
    ...
    .to-dashboard .pg-kpi-grid {
        margin-bottom: 0;
    }

    .to-dashboard .to-kpi--hero .pg-kpi__value {
        font-size: 1.7rem;
        font-weight: 800;
        letter-spacing: -0.035em;
    }

    .to-dashboard .to-kpi .pg-kpi__label {
        margin-top: 0.35rem;
        text-transform: none;
        letter-spacing: 0;
        font-weight: 600;
    ...
    .to-dashboard .to-kpi .pg-kpi__value {
        margin: 0;
    }
    ...
    .to-dealer-table .to-amt {
        font-variant-numeric: tabular-nums;
    }

    .to-dealer-table .to-amt--out {
        font-weight: 700;
        color: #0F172A;
    }

    .to-dealer-table .to-amt--credit {
        color: #15803D;
    }
