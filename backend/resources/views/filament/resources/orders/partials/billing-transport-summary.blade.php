...
@if (filled($record->vehicle_number) || $charges !== null || $hasAdjustment)
    <div class="pg-billing-transport" style="margin:0 0 10px;">
        ...
        <div style="display:flex;justify-content:space-between;gap:16px;padding:4px 0;">
            ...
            <span style="font-size:13px;color:#0F172A;font-weight:600;">{{ $charges === null ? '—' : OrderBillingTransportCalculator::formatMoney((float) $charges) }}</span>
        </div>
        @if ($hasAdjustment)
            <div style="display:flex;justify-content:space-between;gap:16px;padding:4px 0;">
            ...
            <div style="display:flex;justify-content:space-between;gap:16px;padding:4px 0;">
                <span style="font-size:13px;color:#64748B;font-weight:500;">Adjustment</span>
                <span style="font-size:13px;color:#0F172A;font-weight:600;">{{ OrderBillingTransportCalculator::formatAdjustment((float) $adjustment) }}</span>
            </div>
