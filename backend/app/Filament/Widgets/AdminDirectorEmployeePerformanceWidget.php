...
class AdminDirectorEmployeePerformanceWidget extends Widget
{
    ...
    public function setAdminPeriod(string $period): void
    {
    ...
    public function applyAdminCustomPeriod(): void
    {
        $this->validate([
    ...
    public function resetAdminCustomPeriod(): void
    {
        $this->period = 'monthly';
        $this->fromDate = null;
        $this->toDate = null;
    ...
    public function isActiveAdminPeriod(string $period): bool
    {
