...
class ImportDealersAction
{
    public static function make(string $name = 'importDealers'): Action
    {
        return Action::make($name)
            ...
            ->modalDescription('Upload the dealer import template CSV. Required columns: Firm Name, Employee Code, Mobile, State, District, Taluka, Place. Dealer codes are auto-generated. Valid rows are imported even when some rows fail.')
            ->form([
