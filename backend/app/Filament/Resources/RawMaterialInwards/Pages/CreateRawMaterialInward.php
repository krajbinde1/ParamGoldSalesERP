...
class CreateRawMaterialInward extends CreateRecord
{
    ...
    {
        return 'Raw Material Inward created successfully.';
    }

    protected function getRedirectUrl(): string
    {
        return RawMaterialInwardResource::getUrl('index');
    }
    ...
    public function mount(): void
    {
        ...
        $preselectMaterialId = request()->integer('raw_material_id') ?: null;
        if (! $preselectMaterialId) {
            return;
        }

        $material = RawMaterial::query()->find($preselectMaterialId);
        $item = [
            'raw_material_id' => $preselectMaterialId,
