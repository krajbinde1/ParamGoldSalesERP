...
final class PackagingMaterialBulkImporter extends AbstractMaterialBulkImporter
{
    public function __construct(
        private readonly PackagingMaterialCreateService $createService = new PackagingMaterialCreateService,
