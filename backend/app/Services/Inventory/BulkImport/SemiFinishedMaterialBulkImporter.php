...
final class SemiFinishedMaterialBulkImporter extends AbstractMaterialBulkImporter
{
    public function __construct(
        private readonly SemiFinishedMaterialCreateService $createService = new SemiFinishedMaterialCreateService,
    ...
    protected function validateRow(array $data, array &$seenNames): ?string
    {
        ...
        if (SemiFinishedMaterial::query()->whereRaw('LOWER(material_name) = ?', [$nameKey])->exists()) {
